...
class CRNN_Net_2(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = nn.Conv2d(1, 16, kernel_size=(3, 3), stride=3)
        self.conv2 = nn.Conv2d(16, 32, kernel_size=(3, 3), stride=3)
        self.conv3 = nn.Conv2d(32, 64, kernel_size=(3, 3), stride=3)
        self.conv4 = nn.Conv2d(64, 128, kernel_size=(3, 3), stride=3)
        # self.conv5 = nn.Conv2d(128, 256, kernel_size=(3, 3), stride=3)

        self.conv_layers = [self.conv, self.conv2, self.conv3, self.conv4]
    ...
    def forward(self, tensor):
        ...
        for conv_layer in self.conv_layers:
            tensor = F.relu(conv_layer(tensor))
            # print(tensor.shape)
...
if __name__ == '__main__':
    ...
    run_name = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S") + '_june'
