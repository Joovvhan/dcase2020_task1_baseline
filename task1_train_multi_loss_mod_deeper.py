...
class CRNN_Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = nn.Conv2d(1, 128, kernel_size=(80, 11), stride=3)
        self.rnn_1 = nn.RNN(128, 128)
        self.rnn_2 = nn.RNN(128, 128)
        self.rnn_3 = nn.RNN(128, 64)
        self.rnn_4 = nn.RNN(64, 64)
        ...
        self.fc = nn.Linear(64 * output_T, len(SCENE_DICT))
...
if __name__ == '__main__':
    ...
    run_name = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S") + '_ml_4_gru'
